...
// Provjera je li veza s bazom uspješno uspostavljena
if (!$spoj) {
...
<head>
    ...
    <title>Deserti - Kuhinjska čarolija</title>
    ...
    <header>
        <div class="header-container">
            <div class="logo">
                ...
                <h1>Deserti - Kuhinjska čarolija</h1>
            </div>
    ...
    <main>
        <div class="content-container">
            ...
            <div class="recipe-list">
                <?php
                try {
                    // SQL upit za dohvaćanje recepata iz kategorije Deserti
                    $sql = "SELECT * FROM recepti WHERE kategorija_id = (SELECT id FROM kategorije WHERE naziv = 'Deserti') LIMIT 6";
                    ...
                    if ($result->num_rows > 0) {
                        while ($recept = $result->fetch_assoc()) {
                            ...
                            echo "<a href='recept.php?id=" . urlencode($recept['id']) . "'>";
                            ...
                            echo "<p class='read-more'>Pročitaj više</p>"; // Dodatni tekst za 'Pročitaj više'
                            echo "</div>"; // recipe-info
                            echo "</div>"; // recipe-card-content
                            echo "</a>"; // Link koji obuhvaća cijeli recept
                            echo "</div>";
                        }
                    } else {

...
<head>
    ...
    <title>Glavna jela - Kuhinjska čarolija</title>
    ...
    <header>
        <div class="header-container">
            <div class="logo">
                ...
                <h1>Glavna jela - Kuhinjska čarolija</h1>
            </div>
    ...
    <main>
        <div class="content-container">
            ...
            <div class="recipe-list">
                <?php
                try {
                    // SQL upit za dohvaćanje recepata iz kategorije Glavna jela
                    $sql = "SELECT * FROM recepti WHERE kategorija_id = (SELECT id FROM kategorije WHERE naziv = 'Glavna jela') LIMIT 6";
